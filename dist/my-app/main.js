...
/* harmony default export */ __webpack_exports__["default"] = ("<ul>\n  <li *ngFor=\"let family of allFamilies\">\n    <pre>{{ family |json }}</pre>\n  </li>\n</ul>");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                angularfire2__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].firebase, 'wedding-invitation-oplachko'),
                angularfire2_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabaseModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
            ],
            providers: [angularfire2_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"]],
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(db, route) {
        var _this = this;
        this.route = route;
        this.allFamilies = [];
        console.log('this.route.queryParams', this.route.snapshot.params.id);
        this.familiesCollection = db.collection('family');
        this.familyMembersCollection = db.collection('family_member');
        this.families = this.familiesCollection.valueChanges();
        this.familyMembers = this.familyMembersCollection.valueChanges();
        this.families.subscribe(function (f) {
            _this.familyMembers.subscribe(function (m) {
                f.map(function (family) {
                    family.membersInfo = [];
                    family.members.map(function (member, i) {
                        family.membersInfo.push(m.find(function (element) { return element.id === member; }));
                    });
                });
                _this.allFamilies = f;
            });
    ...
    UsersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__importDefault(__webpack_require__(/*! ./users.component.scss */ "./src/app/users/users.component.scss")).default]
        }),
...
var environment = {
    production: true,
    firebase: {
        apiKey: 'AIzaSyDfDVrCQ7jTMUhKIcNuNFhqx5tfo8iCyHA',
        authDomain: 'wedding-invitation-oplachko.firebaseapp.com',
        databaseURL: 'https://wedding-invitation-oplachko.firebaseio.com',
        projectId: 'wedding-invitation-oplachko',
        storageBucket: 'wedding-invitation-oplachko.appspot.com',
        messagingSenderId: '479949525680',
        appId: '1:479949525680:web:92686f33041c65718ba175',
        measurementId: 'G-FNVQRKZ5JN'
    }
};
...
module.exports = __webpack_require__(/*! /Users/elenaborodina/projects/wedding-invitation/src/main.ts */"./src/main.ts");
